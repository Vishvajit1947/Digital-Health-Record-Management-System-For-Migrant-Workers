      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-surface dark:bg-slate-900 p-8">
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 p-10 max-w-md text-center">
            ...
            <h2 className="text-xl font-semibold text-slate-800 dark:text-slate-100 mb-2">{i18n.t('something_went_wrong')}</h2>
            <p className="text-sm text-slate-500 dark:text-slate-400 mb-6 leading-relaxed">{this.state.error?.message || i18n.t('error')}</p>
            <button
